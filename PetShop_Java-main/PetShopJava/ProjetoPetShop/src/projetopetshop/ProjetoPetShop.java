     ...
     while(rodando){
       ...
       System.out.println(e.getMessage());
         ...
         case "9": 
        {
               ...
               if("D".equals(letra))
           {
                ...
                for(Produto p : produto){
                    if(p.getDesc().startsWith(desc)){
                    p.exibir();
                    }
                    else System.out.println("Erro!! - Descricao do produto não Encontrado");
                }
                    break;    
           }
            ...
            if("C".equals(letra))
            {
                ...
                for(Produto p : produto){
                    if(p.getCodBarras().startsWith(cod)){
                    p.exibir();
                    }
                    else System.out.println("Erro!! - Codigo de barras do produto não Encontrado");
                }
                    break;
           ...
           if("P".equals(letra))
           {
                ...
                for(Produto p : produto){
                    ...
                    else System.out.println("Erro!! - Preco do produto não Encontrado");
                }
                    scan.nextLine();
                    break;
           }
                ...
                System.out.println("Caracter incorreto, tente novamente!");
           break;
                ...
                case "RC":
        {
            ...
            System.out.print("Digite o CPF do cliente que sera excluido: \n");
            String cpf = scan.nextLine();
        ...
        case "RF":
        {
            ...
            System.out.print("Digite o RG do funcionario que sera excluido: \n");
            String rg = scan.nextLine();
            boolean excluiu = false;
        ...
        case "RP":
        {
            ...
            System.out.print("Digite o codigo de barras do produto que sera excluído: \n");
            String cod = scan.nextLine();
            boolean excluiu = false;
